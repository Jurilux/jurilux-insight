...
CREATE TABLE IF NOT EXISTS insight_appearances (
    ...
    articles        TEXT,               -- articles de loi visés, normalisés, séparés par « ; » | NULL
    sens            TEXT,               -- sens du dispositif : cassation|rejet|confirmation|réformation|irrecevabilité | NULL
